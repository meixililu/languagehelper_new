...
final class YYJMainActivityPermissionsDispatcher {
  ...
  static void showPermissionWithPermissionCheck(YYJMainActivity target) {
  ...
  static void onRequestPermissionsResult(YYJMainActivity target, int requestCode,
      int[] grantResults) {
    switch (requestCode) {
  ...
  private static final class YYJMainActivityShowPermissionPermissionRequest implements PermissionRequest {
    ...
    private YYJMainActivityShowPermissionPermissionRequest(YYJMainActivity target) {
