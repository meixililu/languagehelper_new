...
/** 
 * DAO for table "TRAN_RECORD_JP".
*/
public class TranRecord_jpDao extends AbstractDao<TranRecord_jp, Long> {

    public static final String TABLENAME = "TRAN_RECORD_JP";

    /**
     * Properties of entity TranRecord_jp.<br/>
    ...
    public TranRecord_jpDao(DaoConfig config) {
        super(config);
    }
    
    public TranRecord_jpDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRAN_RECORD_JP\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRAN_RECORD_JP\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TranRecord_jp entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TranRecord_jp entity) {
        stmt.clearBindings();
    ...
    @Override
    public TranRecord_jp readEntity(Cursor cursor, int offset) {
        TranRecord_jp entity = new TranRecord_jp( //
    ...
    @Override
    public void readEntity(Cursor cursor, TranRecord_jp entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TranRecord_jp entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TranRecord_jp entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TranRecord_jp entity) {
