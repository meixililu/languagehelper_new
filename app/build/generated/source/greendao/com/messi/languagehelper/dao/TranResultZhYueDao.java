...
/** 
 * DAO for table "TRAN_RESULT_ZH_YUE".
*/
public class TranResultZhYueDao extends AbstractDao<TranResultZhYue, Long> {

    public static final String TABLENAME = "TRAN_RESULT_ZH_YUE";

    /**
     * Properties of entity TranResultZhYue.<br/>
    ...
    public TranResultZhYueDao(DaoConfig config) {
        super(config);
    }
    
    public TranResultZhYueDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRAN_RESULT_ZH_YUE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRAN_RESULT_ZH_YUE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TranResultZhYue entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TranResultZhYue entity) {
        stmt.clearBindings();
    ...
    @Override
    public TranResultZhYue readEntity(Cursor cursor, int offset) {
        TranResultZhYue entity = new TranResultZhYue( //
    ...
    @Override
    public void readEntity(Cursor cursor, TranResultZhYue entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TranResultZhYue entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TranResultZhYue entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TranResultZhYue entity) {
