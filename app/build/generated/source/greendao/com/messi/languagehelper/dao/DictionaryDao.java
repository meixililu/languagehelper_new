...
public class DictionaryDao extends AbstractDao<Dictionary, Long> {
    ...
    public static class Properties {
        ...
        public final static Property To_lan = new Property(3, String.class, "to_lan", false, "TO_LAN");
        public final static Property From_lan = new Property(4, String.class, "from_lan", false, "FROM_LAN");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DICTIONARY\" (" + //
                ...
                "\"TO_LAN\" TEXT," + // 3: to_lan
                "\"FROM_LAN\" TEXT," + // 4: from_lan
                "\"PH_AM\" TEXT," + // 5: ph_am
                "\"PH_EN\" TEXT," + // 6: ph_en
                "\"PH_ZH\" TEXT," + // 7: ph_zh
                "\"TYPE\" TEXT," + // 8: type
    ...
    protected final void bindValues(DatabaseStatement stmt, Dictionary entity) {
        ...
        if (to_lan != null) {
            stmt.bindString(4, to_lan);
        }
 
        String from_lan = entity.getFrom_lan();
        if (from_lan != null) {
            stmt.bindString(5, from_lan);
        }
    ...
    public Dictionary readEntity(Cursor cursor, int offset) {
        Dictionary entity = new Dictionary( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // to_lan
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // from_lan
    ...
    public void readEntity(Cursor cursor, Dictionary entity, int offset) {
        ...
        entity.setTo_lan(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setFrom_lan(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
