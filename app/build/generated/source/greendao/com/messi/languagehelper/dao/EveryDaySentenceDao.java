...
public class EveryDaySentenceDao extends AbstractDao<EveryDaySentence, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, EveryDaySentence entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, EveryDaySentence entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(EveryDaySentence entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(EveryDaySentence entity) {
