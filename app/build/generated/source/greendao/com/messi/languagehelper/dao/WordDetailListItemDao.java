...
public class WordDetailListItemDao extends AbstractDao<WordDetailListItem, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, WordDetailListItem entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, WordDetailListItem entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(WordDetailListItem entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(WordDetailListItem entity) {
