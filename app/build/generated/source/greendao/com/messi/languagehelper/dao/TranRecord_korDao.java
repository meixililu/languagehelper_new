...
/** 
 * DAO for table "TRAN_RECORD_KOR".
*/
public class TranRecord_korDao extends AbstractDao<TranRecord_kor, Long> {

    public static final String TABLENAME = "TRAN_RECORD_KOR";

    /**
     * Properties of entity TranRecord_kor.<br/>
    ...
    public TranRecord_korDao(DaoConfig config) {
        super(config);
    }
    
    public TranRecord_korDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRAN_RECORD_KOR\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRAN_RECORD_KOR\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TranRecord_kor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TranRecord_kor entity) {
        stmt.clearBindings();
    ...
    @Override
    public TranRecord_kor readEntity(Cursor cursor, int offset) {
        TranRecord_kor entity = new TranRecord_kor( //
    ...
    @Override
    public void readEntity(Cursor cursor, TranRecord_kor entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TranRecord_kor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TranRecord_kor entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TranRecord_kor entity) {
