...
public class SymbolListDaoDao extends AbstractDao<SymbolListDao, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, SymbolListDao entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SymbolListDao entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(SymbolListDao entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(SymbolListDao entity) {
