...
public class TwistsFragment_ViewBinding implements Unbinder {
  private TwistsFragment target;
  ...
  @UiThread
  public TwistsFragment_ViewBinding(final TwistsFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TwistsFragment target = this.target;
    ...
    view7f08028a.setOnClickListener(null);
    view7f08028a = null;
