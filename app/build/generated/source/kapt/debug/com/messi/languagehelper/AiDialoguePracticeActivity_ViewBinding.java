...
public class AiDialoguePracticeActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public AiDialoguePracticeActivity_ViewBinding(final AiDialoguePracticeActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AiDialoguePracticeActivity target = this.target;
    ...
    view7f080352.setOnClickListener(null);
    view7f080352 = null;
  }
}
