...
final class MainFragmentYYSPermissionsDispatcher {
  ...
  static void showORCDialogWithPermissionCheck(MainFragmentYYS target) {
  ...
  static void showRecordWithPermissionCheck(MainFragmentYYS target) {
  ...
  static void onRequestPermissionsResult(MainFragmentYYS target, int requestCode,
      int[] grantResults) {
    switch (requestCode) {
  ...
  private static final class MainFragmentYYSShowORCDialogPermissionRequest implements PermissionRequest {
    ...
    private MainFragmentYYSShowORCDialogPermissionRequest(MainFragmentYYS target) {
  ...
  private static final class MainFragmentYYSShowRecordPermissionRequest implements PermissionRequest {
    ...
    private MainFragmentYYSShowRecordPermissionRequest(MainFragmentYYS target) {
      this.weakTarget = new WeakReference<MainFragmentYYS>(target);
    }
