...
public class AiDialogueFightActivity_ViewBinding implements Unbinder {
  private AiDialogueFightActivity target;

  @UiThread
  public AiDialogueFightActivity_ViewBinding(AiDialogueFightActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AiDialogueFightActivity_ViewBinding(AiDialogueFightActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AiDialogueFightActivity target = this.target;
