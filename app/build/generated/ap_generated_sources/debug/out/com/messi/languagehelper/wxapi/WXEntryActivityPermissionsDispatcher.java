...
final class WXEntryActivityPermissionsDispatcher {
  private static final int REQUEST_SHOWPERMISSION = 18;
  ...
  static void showPermissionWithPermissionCheck(WXEntryActivity target) {
  ...
  static void onRequestPermissionsResult(WXEntryActivity target, int requestCode,
      int[] grantResults) {
    switch (requestCode) {
  ...
  private static final class WXEntryActivityShowPermissionPermissionRequest implements PermissionRequest {
    ...
    private WXEntryActivityShowPermissionPermissionRequest(WXEntryActivity target) {
