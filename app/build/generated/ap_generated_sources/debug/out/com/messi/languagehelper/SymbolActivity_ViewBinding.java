...
public class SymbolActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public SymbolActivity_ViewBinding(SymbolActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SymbolActivity_ViewBinding(SymbolActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SymbolActivity target = this.target;
