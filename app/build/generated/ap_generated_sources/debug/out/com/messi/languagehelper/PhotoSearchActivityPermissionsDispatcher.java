...
final class PhotoSearchActivityPermissionsDispatcher {
  ...
  static void showORCDialogWithPermissionCheck(PhotoSearchActivity target) {
  ...
  static void onRequestPermissionsResult(PhotoSearchActivity target, int requestCode,
      int[] grantResults) {
    switch (requestCode) {
  ...
  private static final class PhotoSearchActivityShowORCDialogPermissionRequest implements PermissionRequest {
    ...
    private PhotoSearchActivityShowORCDialogPermissionRequest(PhotoSearchActivity target) {
