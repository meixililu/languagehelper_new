...
public class YiZhanDaoDiActivity_ViewBinding implements Unbinder {
  private YiZhanDaoDiActivity target;

  private View view7f080046;

  @UiThread
  public YiZhanDaoDiActivity_ViewBinding(YiZhanDaoDiActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public YiZhanDaoDiActivity_ViewBinding(final YiZhanDaoDiActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    YiZhanDaoDiActivity target = this.target;
