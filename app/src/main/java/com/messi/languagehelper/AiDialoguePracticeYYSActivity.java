...
public class AiDialoguePracticeYYSActivity extends BaseActivity implements View.OnClickListener, SpokenEnglishPlayListener {
    ...
    private String getEnglishContent(AVObject avObject) {
        String temp = avObject.getString(AVOUtil.CantoneseEvaluationDetail.EDContent);
    ...
    public void playItem(AVObject avObject) {
        if (avObject.get(AVOUtil.CantoneseEvaluationDetail.mp3url) != null) {
            playMp3((String) avObject.get(AVOUtil.CantoneseEvaluationDetail.mp3url),
                    SDCardUtil.SpokenEnglishPath, (avObject.getString(AVOUtil.CantoneseEvaluationDetail.EDCode) + ".mp3"));
        } else {
            String path = SDCardUtil.getDownloadPath(SDCardUtil.EvaluationPath);
            String filepath = path + avObject.getString(AVOUtil.CantoneseEvaluationDetail.EDCode) + ".pcm";
    ...
    RecognizerListener recognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            ...
            if (isLast) {
                ...
                UserSpeakBean bean = ScoreUtil.score(AiDialoguePracticeYYSActivity.this, sbResult.toString(), getEnglishContent(mSpeakItem), 0);
