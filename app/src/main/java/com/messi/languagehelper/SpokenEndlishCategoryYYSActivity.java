...
public class SpokenEndlishCategoryYYSActivity extends BaseActivity {
    ...
    private class QueryTask extends AsyncTask<Void, Void, List<AVObject>> {
        ...
        protected void onPostExecute(List<AVObject> avObject) {
            ...
            if (avObject != null) {
                if (avObject.size() == 0) {
                    ToastUtil.diaplayMesShort(SpokenEndlishCategoryYYSActivity.this, "没有了！");
                    hideFooterview();
                } else {
                ...
                ToastUtil.diaplayMesShort(SpokenEndlishCategoryYYSActivity.this, "加载失败，下拉可刷新");
            }
