...
import com.messi.languagehelper.adapter.XmlyMainForYWCDAdapter;
...
public class XmlyMainForYWCDFragment extends BaseFragment implements OnClickListener,
	...
	public static Fragment newInstance(){
		XmlyMainForYWCDFragment fragment = new XmlyMainForYWCDFragment();
		return fragment;
	}
	...
	private void initViews(View view){
		...
		XmlyMainForYWCDAdapter allAdapter = new XmlyMainForYWCDAdapter(getChildFragmentManager(),getContext(),this);
