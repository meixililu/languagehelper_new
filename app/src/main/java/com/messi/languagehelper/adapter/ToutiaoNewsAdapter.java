...
public class ToutiaoNewsAdapter extends BaseAdapter {
	...
	private List<ToutiaoNewsItem> avObjects;

	public ToutiaoNewsAdapter(Context mContext, List<ToutiaoNewsItem> avObjects) {
		context = mContext;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final ToutiaoNewsItem mAVObject = avObjects.get(position);
		...
		if(mNativeADDataRef == null){
			...
			holder.source_name.setText( mAVObject.getAuthor_name() );
			holder.type_name.setText( mAVObject.getRealtype() );
			...
			if(!TextUtils.isEmpty(mAVObject.getThumbnail_pic_s())){
				...
				Glide.with(context)
				.load(mAVObject.getThumbnail_pic_s())
