...
public class RcWebsiteListAdapter extends HeaderFooterRecyclerViewAdapter<RecyclerView.ViewHolder, Object, AVObject, Object> {

    private XFYSAD mXFYSAD;

    public RcWebsiteListAdapter(XFYSAD mXFYSAD){
    ...
    protected RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RcWebsiteItemViewHolder(characterView);
    }

    @Override
    protected void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        AVObject mAVObject = getItem(position);
        RcWebsiteItemViewHolder itemViewHolder = (RcWebsiteItemViewHolder)holder;
