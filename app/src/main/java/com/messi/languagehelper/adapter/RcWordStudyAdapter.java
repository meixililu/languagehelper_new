...
public class RcWordStudyAdapter extends HeaderFooterRecyclerViewAdapter<RecyclerView.ViewHolder, Object, AVObject, Object> {

    @Override
    protected RecyclerView.ViewHolder onCreateHeaderViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = getLayoutInflater(parent);
        View headerView = inflater.inflate(R.layout.word_study_herder_item, parent, false);
        return new RcWordStudyHeaderViewHolder(headerView);
    }

    @Override
    protected void onBindHeaderViewHolder(RecyclerView.ViewHolder holder, int position) {
        RcWordStudyHeaderViewHolder headHolder = (RcWordStudyHeaderViewHolder)holder;
        headHolder.render();
    }
