...
public class RcXmlyRadioListAdapter extends HeaderRecyclerViewAdapter<RecyclerView.ViewHolder, Object, Radio, Object> {

    private List<Radio> radios;

    public RcXmlyRadioListAdapter(List<Radio> radios){
        this.radios = radios;
    }
