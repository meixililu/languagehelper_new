...
public class WechatJXAdapter extends BaseAdapter {

	private LayoutInflater mInflater;
	private Context context;
	private List<WechatJXResult> avObjects;

	public WechatJXAdapter(Context mContext, List<WechatJXResult> avObjects) {
		context = mContext;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final WechatJXResult mAVObject = avObjects.get(position);
