...
public class ReadingFragmentYYS extends BaseFragment implements OnClickListener{
	...
	public static Fragment newInstance(){
		ReadingFragmentYYS fragment = new ReadingFragmentYYS();
		return fragment;
	}
			...
			public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
				...
				if(!mXXLModel.loading && mXXLModel.hasMore){
					if ((visible + firstVisibleItem) >= total){
						new QueryTask(ReadingFragmentYYS.this).execute();
					}
				}
			}
		});
	...
	private class QueryTask extends AsyncTask<Void, Void, List<AVObject>> {
		...
		private WeakReference<ReadingFragmentYYS> mainActivity;

		public QueryTask(ReadingFragmentYYS mActivity){
