...
/**
 * Entity mapped to table TranRecord_jp.
 */
@Entity
public class TranRecord_jp {
    ...
    @Generated(hash = 1084287050)
    public TranRecord_jp(Long id, String english, String chinese, String resultAudioPath,
    ...
    @Generated(hash = 1457690162)
    public TranRecord_jp() {
    }
    public Long getId() {
        return this.id;
    }
