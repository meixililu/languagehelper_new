...
/**
 * Entity mapped to table TranRecord_kor.
 */
@Entity
public class TranRecord_kor {
    ...
    @Generated(hash = 1518235588)
    public TranRecord_kor(Long id, String english, String chinese, String resultAudioPath,
    ...
    @Generated(hash = 315345166)
    public TranRecord_kor() {
    }
    public Long getId() {
        return this.id;
    }
