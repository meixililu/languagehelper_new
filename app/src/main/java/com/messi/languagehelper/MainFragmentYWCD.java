...
public class MainFragmentYWCD extends BaseFragment implements OnClickListener, OrcResultListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.submit_btn_cover) {
            ...
            MainFragmentYWCDPermissionsDispatcher.showORCDialogWithPermissionCheck(this);
        } else if (v.getId() == R.id.speak_round_layout) {
            MainFragmentYWCDPermissionsDispatcher.showRecordWithPermissionCheck(this);
...
//                break;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MainFragmentYWCDPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
